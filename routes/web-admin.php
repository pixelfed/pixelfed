...
Route::domain(config('pixelfed.domain.admin'))->prefix('i/admin')->middleware(['localization'])->group(function () {
    ...
    Route::get('diagnostics/config-cache', [AdminConfigCacheController::class, 'debugPage'])->middleware(['admin', 'dangerzone'])->name('admin.config-cache');
    Route::post('diagnostics/config-cache/clear-cache', [AdminConfigCacheController::class, 'clearCache'])->middleware(['admin', 'dangerzone'])->name('admin.config-cache.clear');
