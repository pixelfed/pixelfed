...
use App\Http\Controllers\Web\AccountInterstitialController;
use App\Http\Controllers\Web\AuthorizeInteractionController;
use App\Http\Controllers\Web\BookmarkController;
use App\Http\Controllers\Web\CommentController;
use App\Http\Controllers\Web\ContactController;
use App\Http\Controllers\Web\CuratedRegisterController;
use App\Http\Controllers\Web\InstallController;
use App\Http\Controllers\Web\LikeController;
use App\Http\Controllers\Web\MediaBlocklistController;
use App\Http\Controllers\Web\MobileController;
use App\Http\Controllers\Web\ParentalControlsController;
use App\Http\Controllers\Web\PersonalAccessTokenController;
use App\Http\Controllers\Web\PlaceController;
use App\Http\Controllers\Web\ProfileAliasController;
use App\Http\Controllers\Web\ProfileMigrationController;
use App\Http\Controllers\Web\RemoteAuthController;
use App\Http\Controllers\Web\RemoteOidcController;
use App\Http\Controllers\Web\ReportController;
use App\Http\Controllers\Web\SiteController;
use App\Http\Controllers\Web\TimelineController;
use App\Http\Controllers\Web\UserEmailForgotController;
use App\Http\Controllers\Web\UserInviteController;
