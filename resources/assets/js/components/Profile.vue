    ...
    <div class="w-100 h-100">
        <div v-if="isMobile" class="bg-white p-3 border-bottom">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a
                        class="fas fa-ellipsis-v fa-lg text-muted text-decoration-none"
                        href="#"
        ...
        <div
            v-if="relationship && relationship.blocking && warning"
            class="bg-white pt-3 border-bottom"
        >
            <div class="container">
        ...
        <div v-if="!loading && !warning">
            <div v-if="layout == 'metro'" class="container">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-4 d-md-flex">
                                <div class="profile-avatar mx-md-auto">
                                    ...
                                    <div class="d-block d-md-none mt-n3 mb-3">
                                        <div class="row">
                                            <div class="col-4">
                                                <div
                                                    v-if="hasStory"
                                                    class="has-story cursor-pointer shadow-sm"
                                                    @click="storyRedirect()"
                                                >
                                                    <img
                                                        :alt="
                                            ...
                                            <div class="col-8">
                                                <div
                                                    class="d-block d-md-none mt-3 py-2"
                                                >
                                                    <ul
                                                    ...
                                                    >
                                                        ...
                                                        <li class="nav-item">
                                                            ...
                                                            >
                                                                <a
                                                                    class="text-dark cursor-pointer text-center"
                                                                    v-on:click="
                                                                        followersModal()
                                                                    "
                                                                >
                                    ...
                                    <div class="d-none d-md-block pb-3">
                                        <div
                                            v-if="hasStory"
                                            class="has-story-lg cursor-pointer shadow-sm"
                                            @click="storyRedirect()"
                                        >
                                            <img
                                                :alt="
                                        ...
                                        <p
                                            v-if="
                                                sponsorList.patreon ||
                                                sponsorList.liberapay ||
                                                sponsorList.opencollective
                                            "
                                        ...
                                        >
                                            <button
                                                ...
                                                class="btn btn-outline-secondary font-weight-bold py-0"
                                            >
                                                <i
                            ...
                            >
                                <div class="profile-details">
                                    <div
                                        class="d-none d-md-flex username-bar pb-3 align-items-center"
                                    >
                                        <span
                                            class="font-weight-ultralight h3 mb-0"
                                        ...
                                        >
                                            ...
                                            >
                                                <a
                                                    :href="
                                                        ...
                                                        profile.id
                                                    "
                                                    class="btn btn-outline-secondary font-weight-bold btn-sm py-1 text-dark mr-2 px-3 btn-sec-alt"
                                                    style="
                                                        border: 1px solid
                                                            #dbdbdb;
                                                    "
                                                ...
                                                <button
                                                    type="button"
                                                    class="btn btn-outline-secondary font-weight-bold btn-sm py-1 text-dark btn-sec-alt"
                                                    style="
                                                        border: 1px solid
                                                            #dbdbdb;
                                                    "
                                            ...
                                            >
                                                <button
                                                    type="button"
                                                    class="btn btn-primary font-weight-bold btn-sm py-1 px-3"
                                                    v-on:click="followProfile"
                                                    data-toggle="tooltip"
                                                    title="Follow"
                                                >
                                        ...
                                        <span class="pl-4">
                                            <a
                                                class="fas fa-ellipsis-h fa-lg text-dark text-decoration-none"
                                                href="#"
                                                @click.prevent="visitorMenu"
                                            ></a>
                                        </span>
                                    ...
                                    <div class="font-size-16px">
                                        <div
                                            class="d-none d-md-inline-flex profile-stats pb-3"
                                        >
                                            ...
                                            <div
                                                v-if="
                                                    profileSettings.followers
                                                        .count
                                                "
                                                class="font-weight-light pr-5"
                                            >
                                                <a
                                        ...
                                        <div
                                            class="d-md-flex align-items-center mb-1 text-break"
                                        >
                                        ...
                                        <p
                                            class="d-flex small text-muted align-items-center"
                                        >
                                            <span
                                                v-if="profile.is_admin"
                                                class="btn btn-outline-danger btn-sm py-0 mr-3"
                                                title="Admin Account"
                                                data-toggle="tooltip"
                                            >
                                                {{ $t("profile.admin") }}
                                            ...
                                            <span
                                                ...
                                                "
                                                class="btn btn-outline-muted btn-sm py-0 mr-3"
                                                >{{
                                                    $t("profile.followYou")
                                                }}</span
                                            >
                ...
                <div
                    ...
                    class="d-block d-md-none my-0 pt-3 border-bottom"
                >
                    <p class="pt-3">
                        <button
                            v-if="owner"
                            class="btn btn-outline-secondary bg-white btn-sm py-1 btn-block text-center font-weight-bold text-dark border border-lighter"
                            @click.prevent="redirect('/settings/home')"
                        >
                            {{ $t("profile.editProfile") }}
                        </button>
                        <button
                            v-if="!owner && relationship.following"
                            class="btn btn-outline-secondary bg-white btn-sm py-1 px-5 font-weight-bold text-dark border border-lighter"
                            @click="followProfile"
                        >
                            &nbsp;&nbsp; Unfollow &nbsp;&nbsp;
                        </button>
                        <button
                            v-if="!owner && !relationship.following"
                            class="btn btn-primary btn-sm py-1 px-5 font-weight-bold"
                            @click="followProfile"
                        >
                            {{
                                relationship.followed_by
                ...
                <div class="">
                    <ul
                        class="nav nav-topbar d-flex justify-content-center border-0"
                    >
                        <li class="nav-item border-top">
                            <a
                                ...
                                "
                                href="#"
                                v-on:click.prevent="switchMode('grid')"
                                ><i class="fas fa-th"></i>
                                <span
                                    class="d-none d-md-inline-block small pl-1"
                                    >POSTS</span
                                ></a
                            >
                        </li>
                        <li class="nav-item px-0 border-top">
                            <a
                                ...
                                "
                                href="#"
                                v-on:click.prevent="switchMode('collections')"
                        ...
                        <li v-if="owner" class="nav-item border-top">
                            <a
                                ...
                                "
                                href="#"
                                v-on:click.prevent="switchMode('bookmarks')"
                        ...
                        <li v-if="owner" class="nav-item border-top">
                            <a
                                ...
                                "
                                href="#"
                                v-on:click.prevent="switchMode('archives')"
                ...
                <div class="container px-0">
                    <div class="profile-timeline mt-md-4">
                        <div v-if="mode == 'grid'">
                            <div class="row">
                                <div
                                    class="col-4 p-1 p-md-3"
                                    v-for="(s, index) in timeline"
                                    :key="'tlob:' + index"
                                >
                                    <a
                                    ...
                                    >
                                        <div class="square">
                                            ...
                                            >
                                                <div
                                                    class="info-overlay-text-label"
                                                >
                                                    <h5
                                                        class="text-white m-auto font-weight-bold"
                                                    >
                                                        <span>
                                                            <span
                                                                class="far fa-eye-slash fa-lg p-2 d-flex-inline"
                                                            ></span>
                                                        </span>
                                                    </h5>
                                                </div>
                                            ...
                                            <span
                                                ...
                                                "
                                                class="float-right mr-3 post-icon"
                                                ><i
                                                    class="fas fa-images fa-2x"
                                                ></i
                                            ></span>
                                            <span
                                                v-if="s.pf_type == 'video'"
                                                class="float-right mr-3 post-icon"
                                                ><i
                                            ...
                                            <div class="info-overlay-text">
                                                ...
                                                >
                                                    <span>
                                                        <span
                                                            class="far fa-comment fa-lg p-2 d-flex-inline"
                                                        ></span>
                                                        <span
                                                            class="d-flex-inline"
                                                            >{{
                                ...
                                <div v-if="timeline.length == 0" class="col-12">
                                    <div class="py-5 text-center text-muted">
                                        <p>
                                            <i
                                                class="fas fa-camera-retro fa-2x"
                                            ></i>
                                        </p>
                                        <p class="h2 font-weight-light pt-3">
                                            No posts yet
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div v-if="mode == 'bookmarks'">
                            <div v-if="bookmarksLoading">
                                <div class="row">
                                    <div class="col-12">
                                        <div
                                            class="p-1 p-sm-2 p-md-3 d-flex justify-content-center align-items-center"
                                            style="height: 30vh"
                                        >
                                            <img
                                                src="/img/pixelfed-icon-grey.svg"
                                                class=""
                                            />
                                        </div>
                                    </div>
                                            ...
                                            <div class="square">
                                                ...
                                                <div class="info-overlay-text">
                                                    ...
                                                    >
                                                        <span>
                                                            <span
                                                                class="fas fa-retweet fa-lg p-2 d-flex-inline"
                                                            ></span>
                                                            <span
                                                                class="d-flex-inline"
                                                                >{{
                        ...
                        <div v-if="mode == 'collections'">
                            <div
                                v-if="collections.length && collectionsLoaded"
                                class="row"
                            >
                                <div
                                    class="col-4 p-1 p-sm-2 p-md-3"
                        ...
                        <div v-if="mode == 'archives'">
                            <div
                                ...
                                class="col-12 col-md-8 offset-md-2 px-0 mb-sm-3 timeline mt-5"
                            >
                                <div class="alert alert-info">
                                    <p class="mb-0">
                                        Posts you archive can only be seen by
                                        you.
                                    </p>
                                    <p class="mb-0">
                                        For more information see the
                                        <a href="/site/kb/sharing-media"
                                            >Sharing Media</a
                                        >
                                        help center page.
                                    </p>
                                ...
                                <infinite-loading
                                    @infinite="archivesInfiniteLoader"
                                >
                                    <div slot="no-more"></div>
                                    <div slot="no-results"></div>
                                </infinite-loading>
        ...
        >
            ...
            >
                <div v-if="!following.length" class="list-group-item border-0">
                    <p
                        class="text-center mb-0 font-weight-bold text-muted py-5"
                    >
                        <span class="text-dark">{{ profileUsername }}</span> is
                        not following yet
                    </p>
                </div>
                <div v-else>
                    <div
                        class="list-group-item border-0 py-1 mb-1"
                    ...
                    >
                        <div class="media">
                            <a :href="profileUrlRedirect(user)">
                                <img
                                    class="mr-3 rounded-circle box-shadow"
                                    :src="user.avatar"
                            ...
                            <div class="media-body text-truncate">
                                ...
                                <p
                                    v-if="!user.local"
                                    class="text-muted mb-0 text-break mr-3"
                    ...
                    <div
                        v-if="!followingLoading && following.length == 0"
                        class="list-group-item border-0"
                    >
                        <div class="list-group-item border-0 pt-5">
                            <p class="p-3 text-center mb-0 lead">
                                No Results Found
                            </p>
                        </div>
                    </div>
                    <div
                        v-if="following.length > 0 && followingMore"
                        class="list-group-item text-center"
                        v-on:click="followingLoadMore()"
                    >
                        <p
                            class="mb-0 small text-muted font-weight-light cursor-pointer"
                        >
                            Load more
                        </p>
                    </div>
        ...
        >
            <div
                v-if="!followerLoading"
                class="list-group"
                style="max-height: 60vh"
            >
                <div
                    v-if="!followerLoading && !followers.length"
                    class="list-group-item border-0"
                >
                    <p
                        class="text-center mb-0 font-weight-bold text-muted py-5"
                    >
                        <span class="text-dark">{{ profileUsername }}</span> has
                        no followers yet
                    </p>
                </div>
                ...
                <div v-else>
                    ...
                    <div
                        v-if="followers.length && followerMore"
                        class="list-group-item text-center"
                        v-on:click="followersLoadMore()"
                    >
                        <p
                            class="mb-0 small text-muted font-weight-light cursor-pointer"
                        >
        ...
        >
            <div class="list-group" v-if="relationship">
                <div
                    class="list-group-item cursor-pointer text-center rounded text-dark"
                    @click="copyProfileLink"
                >
                    Copy Link
                </div>
                <div
                    v-if="profile.locked == false"
                    class="list-group-item cursor-pointer text-center rounded text-dark"
                    @click="showEmbedProfileModal"
                >
                    Embed
                </div>
                <div
                    v-if="user && !owner && !relationship.following"
                    class="list-group-item cursor-pointer text-center rounded text-dark"
                    @click="followProfile"
                >
                    Follow
                ...
                <div
                    v-if="user && !owner && relationship.following"
                    class="list-group-item cursor-pointer text-center rounded"
                    @click="followProfile"
                >
                    Unfollow
                </div>
                <div
                    v-if="user && !owner && !relationship.muting"
                    class="list-group-item cursor-pointer text-center rounded"
                    @click="muteProfile"
                >
                    Mute
                ...
                <div
                    v-if="user && !owner && !relationship.blocking"
                    class="list-group-item cursor-pointer text-center rounded text-dark"
                    @click="blockProfile"
                >
                    Block
                ...
                <div
                    v-if="user && owner"
                    class="list-group-item cursor-pointer text-center rounded text-dark"
                    @click="redirect('/settings/home')"
                >
                    Settings
                </div>
                <div
                    class="list-group-item cursor-pointer text-center rounded text-dark"
                    @click="redirect('/users/' + profileUsername + '.atom')"
                >
                    Atom Feed
                </div>
                <div
                    class="list-group-item cursor-pointer text-center rounded text-muted font-weight-bold"
                    @click="$refs.visitorContextMenu.hide()"
                >
                    Close
                </div>
            </div>
        ...
        >
            <div>
                ...
                <p v-if="sponsorList.patreon" class="pt-2">
                    <a
                        :href="'https://' + sponsorList.patreon"
                        rel="nofollow"
                        class="font-weight-bold"
                        >{{ sponsorList.patreon }}</a
                    >
                </p>
                <p v-if="sponsorList.liberapay" class="pt-2">
                    <a
                        :href="'https://' + sponsorList.liberapay"
                        rel="nofollow"
                        class="font-weight-bold"
                        >{{ sponsorList.liberapay }}</a
                    >
                </p>
                <p v-if="sponsorList.opencollective" class="pt-2">
                    <a
                        :href="'https://' + sponsorList.opencollective"
                        rel="nofollow"
                        class="font-weight-bold"
                        >{{ sponsorList.opencollective }}</a
                    >
                </p>
            </div>
        </b-modal>
        ...
        >
            <div>
                <textarea
                    class="form-control disabled text-monospace"
                    rows="6"
                    style="
                        overflow-y: hidden;
                ...
                <p class="mb-0 px-2 small text-muted">
...
export default {
    ...
    beforeMount() {
        ...
        if (u.has("m") && this.modes.includes(u.get("m"))) {
            ...
            if (this.mode == "collections") {
                axios
                    .get("/api/local/profile/collections/" + this.profileId)
                    .then((res) => {
            ...
            if (this.mode == "archives") {
                axios
                    .get("/api/pixelfed/v2/statuses/archives")
                    .then((res) => {
    ...
    mounted() {
        ...
        if (
            document
                ...
                .classList.contains("loggedIn") == true
        ) {
            axios
                .get("/api/pixelfed/v1/accounts/verify_credentials")
                .then((res) => {
                    this.user = res.data;
    ...
    methods: {
        fetchProfile() {
            axios
                .get("/api/pixelfed/v1/accounts/" + this.profileId)
                .then((res) => {
        ...
        fetchPosts() {
            let apiUrl =
                "/api/pixelfed/v1/accounts/" + this.profileId + "/statuses";
            axios
                .get(apiUrl, {
                    params: {
                        limit: 9,
        ...
        previewUrl(status) {
            return status.sensitive
                ? "/storage/no-preview.png?v=" + new Date().getTime()
        ...
        replyUrl(status) {
            ...
            let id =
                status.account.id == this.profile.id
                    ? status.id
        ...
        fetchRelationships() {
            if (
                document
                    .querySelectorAll("body")[0]
                    .classList.contains("loggedIn") == false
            ) {
                return;
            }
            axios
                ...
                .then((res) => {
                    ...
                    if (
                        ...
                        axios
                            .get("/api/web/stories/v1/exists/" + this.profileId)
                            .then((res) => {
        ...
        muteProfile(status = null) {
            ...
            axios
                ...
                .then((res) => {
                    ...
                    swal(
                        "Success",
                        "You have successfully muted " + this.profile.acct,
                        "success"
                    );
                })
                .catch((err) => {
        ...
        unmuteProfile(status = null) {
            ...
            axios
                ...
                .then((res) => {
                    ...
                    swal(
                        "Success",
                        "You have successfully unmuted " + this.profile.acct,
                        "success"
                    );
                })
                .catch((err) => {
        ...
        blockProfile(status = null) {
            ...
            axios
                ...
                .then((res) => {
                    ...
                    swal(
                        "Success",
                        "You have successfully blocked " + this.profile.acct,
                        "success"
                    );
                })
                .catch((err) => {
        ...
        unblockProfile(status = null) {
            ...
            axios
                ...
                .then((res) => {
                    ...
                    swal(
                        "Success",
                        "You have successfully unblocked " + this.profile.acct,
                        "success"
                    );
                })
                .catch((err) => {
        ...
        followingModal() {
            if ($("body").hasClass("loggedIn") == false) {
                window.location.href = encodeURI(
                    "/login?next=/" + this.profileUsername + "/"
                );
                return;
            }
            ...
            if (this.followingCursor) {
                ...
                axios
                    .get("/api/v1/accounts/" + this.profileId + "/following", {
                        params: {
        ...
        followersModal() {
            ...
            if (this.followerCursor > 1) {
                ...
                axios
                    .get("/api/v1/accounts/" + this.profileId + "/followers", {
                        params: {
        ...
        followingLoadMore() {
            if ($("body").hasClass("loggedIn") == false) {
                window.location.href = encodeURI(
                    "/login?next=/" + this.profile.username + "/"
                );
                return;
            }
            axios
                .get("/api/v1/accounts/" + this.profile.id + "/following", {
                    params: {
                        cursor: this.followingCursor,
                        limit: 40,
                        _pe: 1,
        ...
        followersLoadMore() {
            ...
            axios
                .get("/api/v1/accounts/" + this.profile.id + "/followers", {
                    params: {
                        cursor: this.followerCursor,
                        limit: 40,
                        _pe: 1,
        ...
        momentBackground() {
            ...
            if (this.profile.header_bg) {
                c +=
                    this.profile.header_bg == "default"
                        ? "bg-pixelfed"
                        : "bg-moment-" + this.profile.header_bg;
            } else {
                c += "bg-pixelfed";
            }
            return c;
        ...
        loadSponsor() {
            axios
                .get("/api/local/profile/sponsor/" + this.profileId)
                .then((res) => {
        ...
        showEmbedProfileModal() {
            this.ctxEmbedPayload = window.App.util.embed.profile(
                this.profile.url
            );
            this.$refs.visitorContextMenu.hide();
