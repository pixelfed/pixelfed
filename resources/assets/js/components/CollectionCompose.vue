				...
				<div class="card rounded-0 shadow-none border border-top-0">
					<div class="card-body" style="height: 460px; overflow-y: auto">
						<div v-if="tab == 'all'" class="row">
							<div class="col-4 p-1" v-for="(s, index) in posts" :key="index">
						...
						<div v-if="tab == 'add'">
							...
							<div class="form-group pt-4">
								...
								<div>
									<div v-for="(s, index) in recentPosts" :key="index" :class="[selectedPost == s.id ? 'box-shadow border border-warning d-inline-block m-1':'d-inline-block m-1']" @click="selectPost(s)">
