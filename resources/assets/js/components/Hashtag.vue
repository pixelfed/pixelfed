                        ...
                        <div :class="[tag.status.filter ? 'square ' + tag.status.filter : 'square']">
                            ...
                            <div class="info-overlay-text">
                                <h5 class="text-white m-auto font-weight-bold d-flex flex-column" style="gap:.5rem;">
                                    ...
                                    <span class="d-flex-inline">{{formatCount(tag.status.favourites_count)}}</span>
                                    </span>
                                    <span>
                                        <span class="far fa-retweet fa-lg p-2 d-flex-inline"></span>
                                        <span class="d-flex-inline">{{formatCount(tag.status.reblogs_count)}}</span>
                                    </span>
                                    <span>
                                        <span class="far fa-comment fa-lg p-2 d-flex-inline"></span>
                                        <span class="d-flex-inline">{{formatCount(tag.status.reply_count)}}</span>
                                    </span>
                                </h5>
                            </div>
                        </div>
