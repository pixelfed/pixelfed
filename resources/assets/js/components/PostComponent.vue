          ...
          <div class="d-flex flex-md-column flex-column-reverse h-100">
            ...
            <div class="card-body flex-grow-0 py-1">
              <div class="reactions my-1">
                <button v-bind:class="[reactions.liked ? 'fas fa-heart text-danger pr-3 m-0' : 'far fa-heart pr-3 m-0 like-btn']" title="Like" v-on:click="likeStatus">Like</button>
                <button class="far fa-comment pr-3 m-0" title="Comment" v-on:click="commentFocus" type="button">Reply</button>
                <button v-bind:class="[reactions.shared ? 'far fa-share-square pr-3 m-0 text-primary' : 'far fa-share-square pr-3 m-0 share-btn']" title="Share" v-on:click="shareStatus">Boost</button>
                <button v-bind:class="[reactions.bookmarked ? 'fas fa-bookmark text-warning m-0 float-right' : 'far fa-bookmark m-0 float-right']" title="Bookmark" v-on:click="bookmarkStatus">Bookmark</button>
              </div>
