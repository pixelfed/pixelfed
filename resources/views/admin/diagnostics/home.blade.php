...
<div class="pb-3 border-bottom">
	...
	<table style="width:100%" border="1">
      ...
      <tr>
        ...
        <td><strong>Recommended:</strong> "production"</td>
      </tr>
      <tr>
        <td><span class="badge badge-primary">APP</span></td>
        <td><strong>APP_DEBUG</strong></td>
        <td><span>{{config('app.debug') ? '✅ true' : '❌ false' }}</span></td>
        <td><strong>Recommended:</strong> "false"</td>
      </tr>
      <tr>
        <td><span class="badge badge-primary">APP</span></td>
        <td><strong>APP_URL</strong></td>
        <td><span>{{config('app.url')}}</span></td>
        <td><strong>Recommended:</strong> Use full domain name including protocol. <strong>Example:</strong> "https://instance.com"</td>
      </tr>
      <tr>
        <td><span class="badge badge-primary">APP</span></td>
      ...
      <tr>
        <td><span class="badge badge-primary">IMAGE OPTIMIZER</span></td>
      ...
      <tr>
        ...
        <td><strong>Recommended:</strong> redis</td>
      </tr>
