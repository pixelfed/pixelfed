...
<div class="pb-3 border-bottom">
	...
	<tr>
		...
		<td><span>****************************************************************</span></td>
		<td><strong><strong>Keep this secret, and don't change it or things will break</strong><br>Notes:</strong> Generate this key with 'php artisan key:generate'</td>
		<td>✅</td>
	</tr>
	...
	<tr>
		...
		<td><strong>Default:</strong> "phpredis"<br><strong>Notes:</strong> Supports "phpredis" and "predis"</td>
		<td>✅</td>
	</tr>
	...
	<tr>
		...
		<td><strong>Default:</strong> "gd"<br><strong>Notes:</strong> "Supports "gd" and "imagick"</td>
		<td>?</td>
	</tr>
	...
	<tr>
		...
		<td><strong>Default:</strong> "❌ false"<br><strong>Recommended:</strong> "✅ true"</td>
		<td>?</td>
	</tr>
	<tr>
		<td><span class="badge badge-primary">PIXELFED</span></td>
	...
	<tr>
		...
		<td><strong>Default:</strong> "86400"<br><strong>Recommended:</strong> "86400"</td>
		<td>✅</td>
	</tr>
	<tr>
		<td><span class="badge badge-primary">SESSION</span></td>
