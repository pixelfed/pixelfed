...
<div class="pb-3 border-bottom">
	...
	<table style="width:100%" border="1">
      ...
      <tr>
        ...
        <td><strong>RESTRICT_HTML_TYPES (true/false)</strong></td>
        <td><span>{{config('purify.settings.HTML.Allowed')}}</span></td>
        <td></td>
      </tr>

      <tr>
        <td><span class="badge badge-primary">QUEUE</span></td>
        <td><strong>QUEUE_DRIVER (redis/database/sync)</strong></td>
