    ...
    <div class="card">
      <div class="card-body">
        <p class="mb-0">
          ...
          <span class="font-weight-bold pr-1"><bdi><a class="text-dark" href="{{$status->profile->url()}}">{{ \Illuminate\Support\Str::limit($status->profile->username, 15)}}</a></bdi></span>
        ...
        <div class="comments">
          ...
          <p class="mb-2">
            <span class="font-weight-bold pr-1">
              ...
              <bdi><a class="text-dark" href="{{$item->profile->url()}}">{{ \Illuminate\Support\Str::limit($item->profile->username, 15)}}</a></bdi>
            </span>
