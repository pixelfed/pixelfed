...
@section('section')
  ...
  <div class="title">
    <h3 class="font-weight-bold">{{ __('Blocked Users')}}</h3>
  </div>
  <hr>
  <div class="form-group pb-1">
    <p>
      <a class="btn btn-outline-secondary py-0 font-weight-bold" href="{{route('settings.privacy.muted-users')}}">{{ __('Muted Users')}}</a>
      <a class="btn btn-outline-primary py-0 font-weight-bold" href="{{route('settings.privacy.blocked-users')}}">{{ __('Blocked Users')}}</a>
      ...
      <div class="d-flex justify-content-between align-items-center font-weight-bold">
        ...
        <span class="btn-group">
          <form method="post">
            ...
            <button type="submit" class="btn btn-outline-secondary btn-sm px-3 font-weight-bold">{{ __('Unblock<')}}/button>
          </form>
        </span>
      </div> 
    </li>
  ...
  @else
  <p class="lead">{{ __('You are not blocking any accounts.')}}</p>
  @endif
