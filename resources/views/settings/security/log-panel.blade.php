    <div class="mb-4 pb-4">
      <h4 class="font-weight-bold">{{ __('Account Log')}}</h4>
      <hr>
      <ul class="list-group border" style="max-height: 400px;overflow-y: auto;">
        @if($activity->count() == 0) 
        <p class="alert alert-info font-weight-bold">{{ __('No activity logs found!')}}</p>
        @endif
          ...
          <div class="media">
            <div class="media-body">
              ...
              <div class="collapse" id="log-details-{{$log->id}}">
              	<div class="py-2">
              		<p class="mb-0">
              			<span class="font-weight-bold">{{ __('IP Address')}}:</span>
              			<span>
              				{{$log->ip_address}}
              			</span>
              		</p>
            		<p class="mb-0">
              			<span class="font-weight-bold">{{ __('User Agent')}}:</span>
              			<span>
              				{{$log->user_agent}}
              			</span>
              		</p>
