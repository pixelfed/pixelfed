	            ...
	            <div class="card bg-glass">
	                ...
	                <div class="card-body">
	                    <form id="passwordReset" method="POST" action="{{ route('password.request') }}">
							...
							<x-captcha surface="password_reset" theme="dark" :label="true" labelClass="font-weight-bold small pt-3 text-muted" :show-error="true" wrapperClass="d-flex flex-grow-1" />
