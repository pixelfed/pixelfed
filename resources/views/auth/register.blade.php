...
<div class="container mt-4">
    <div class="row justify-content-center">
        <div class="col-lg-5">
            <div class="card">
                <div class="card-header bg-white p-3 text-center font-weight-bold">{{ __('auth.registerNewAccount') }}</div>
                    ...
                    <form method="POST" action="{{ route('register') }}" class="px-md-3">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" placeholder="{{ __('auth.name') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <label class="small font-weight-bold text-lighter">{{ __('auth.email') }}</label>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <label class="small font-weight-bold text-lighter">{{ __('auth.confirmPassword') }}</label>
                        ...
                        <p class="small">{!! __('auth.agreement',['terms' => route('site.terms'),'privacy' => route('site.privacy')])!!}</p>
