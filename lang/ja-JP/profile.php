...
return [
    ...
    'savedWarning' => 'あなたが保存したものはあなただけが見ることができます。',
    ...
    'block.domain.max' => 'ドメインブロック数の上限に達しました。ドメインブロックは :max 件までしか行えません。サーバー管理者に上限の調整について相談してみることをお勧めします。',

    'mutedAccounts' => 'ミュートしたアカウント',
