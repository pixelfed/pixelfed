...
return [
    ...
    'common' => [
        ...
        'javascript' => 'Por favor, habilite javascript para ver este contenido.',
        'loading' => 'Cargando...',
        'continue' => 'Continuar',
    ],
    ...
    'appearance' => [
        'theme' => 'Tema',
        'profileLayout' => 'Diseño del perfil',
        'compactPreviews' => 'Previsualización de medios compactos',
        'loadComments' => 'Cargar comentarios',
        'hideStats' => 'Ocultar recuentos y estadísticas',
    ...
    'powered_by_pixelfed' => 'Desarrollado por',
    ...
    'landing' => [
        ...
        'explore' => 'Explora',
        'decentralized_by_pixelfed' => 'Red social descentralizada para compartir fotos, desarrollada por <a href="https://pixelfed.org" target="_blank">Pixelfed</a>',
        'posts' => 'Publicaciones',
        'active_users' => 'Usuarios activos',
        'total_users' => 'Total de usuarios',
        'managed_by' => 'Administrado por',
        'server_rules' => 'Reglas del servidor',
        'supported_features' => 'Características soportadas',
        'features' => [
            'photo_posts' => 'Publicaciones de fotos',
            ...
            'notifications' => 'Notificaciones',
            'shares' => 'Compartidos',
            'share_up_to_n_photos' => 'Puedes compartir hasta <span class="font-weight-bold">{num_photos}</span> fotos al mismo tiempo con hasta <span class="font-weight-bold">{caption_length}</span> caracteres en la descripción.',
            'share_up_to_n_photos_videos' => 'Puedes compartir hasta <span class="font-weight-bold">{num_photos}</span> fotos o hasta <span class="font-weight-bold">{num_video}</span> videos* al mismo tiempo con hasta <span class="font-weight-bold">{caption_length}</span> caracteres en la descripción.',
            'file_size' => '* - El tamaño máximo del archivo es {max_size}',
            'federation' => 'Federación',
            'mobile_app' => 'Soporte para aplicaciones móviles',
            'stories' => 'Historias',
            'videos' => 'Videos',
        ],
        'discover_accounts' => 'Descubre cuentas y personas',
        'nothing_to_show' => '¡Aún no hay nada que mostrar! Vuelve más tarde.',
        'explore_trending' => 'Explora publicaciones en tendencia',
    ],
];
